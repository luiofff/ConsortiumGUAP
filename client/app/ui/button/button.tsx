...
import button_logo from "../../../public/button_logo.svg";
        ...
        <>
            <div className={styles.btn_block}>
                <div className={styles.buttons}>
                    ...
                    <button className={clsx(styles['discord-button'], styles.button)} style={{ transitionDelay: '0s, 0s, 0s', transitionProperty: 'translate, background, box-shadow' }}>
                    ...
                    <button className={clsx(styles['twitter-button'], styles.button)}  style={{ transitionDelay: '0.1s, 0.1s, 0.1s', transitionProperty: 'translate, background, box-shadow' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
                    ...
                    <button className={clsx(styles['reddit-button'], styles.button)}  style={{ transitionDelay: '0.2s, 0.2s, 0.2s', transitionProperty: 'translate, background, box-shadow' }}>
                    ...
                    <button className={clsx(styles['messenger-button'], styles.button)}  style={{ transitionDelay: '0.3s, 0.3s, 0.3s', transitionProperty: 'translate, background, box-shadow' }}>
                    <svg width="30" height="30" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className={clsx(styles['pinterest-button'], styles.button)}  style={{ transitionDelay: '0.4s, 0.4s, 0.4s', transitionProperty: 'translate, background, box-shadow' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
                    ...
                    <button className={clsx(styles['instagram-button'], styles.button)}  style={{ transitionDelay: '0.5s, 0.5s, 0.5s', transitionProperty: 'translate, background, box-shadow' }}>
                    <svg width="30" height="30" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className={clsx(styles['snapchat-button'], styles.button)}   style={{ transitionDelay: '0.6s, 0.6s, 0.6s', transitionProperty: 'translate, background, box-shadow' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
                    ...
                    <button className={clsx(styles['whatsapp-button'], styles.button)}  style={{ transitionDelay: '0.7s, 0.7s, 0.7s', transitionProperty: 'translate, background, box-shadow' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
